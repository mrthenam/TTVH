...
const PRESETS = [
  ...
  { kw: ['menu', 'thuc don', 'mon gi', 'do uong', 'co mon'],
    a: 'Mỗi thương hiệu có menu riêng — trà sữa MAYCHA & Tâm Hảo, gà giòn Ba Cô Gái, trà TràHú. Bạn muốn xem menu thương hiệu nào ạ?' },
  ...
  { kw: ['zalo', 'lien he', 'hotline', 'so dien thoai', 'sdt', 'contact', 'email'],
    a: 'Bạn có thể liên hệ tụi mình qua Zalo hoặc email nhonnhh@maycha.com.vn. Tụi mình luôn sẵn sàng hỗ trợ! 🌸' },
